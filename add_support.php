...
<main class="main-content" style="max-width:900px;margin:2rem auto;">
    <div class="card glass">
        ...
        $isAjax = isset($_GET['ajax']) || isset($_POST['ajax']) || (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest');
        ...
        // If requested as ajax fragment, return only the inner card HTML
        ...
        // For non-ajax GET, include header and render full page
        require_once 'user_header.php';
        ?>
        <!DOCTYPE html>
        <html lang="ru">
        ...
        <main class="main-content" style="max-width:900px;margin:2rem auto;">
            <?php
            // render the same fragment inside the page
            $_GET['ajax'] = 1;
            include __FILE__;
            ?>
        </main>
